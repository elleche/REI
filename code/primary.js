	...
	var minCloudFontSize = 0.9;
	var maxCloudFontSize = 1.9;
	var activeTag = '';
	var previousTag = '';
...
//	var capitalTags = ['european union', 'united nations'];
	var projectVisuals = [];
	var dataTable;
	var projectsLocation = 'https://docs.google.com/spreadsheet/tq?key=0Aq_Q__MOujOMdHlhNG9QZE9tY2k1SHk3bjV1Z25Ebnc&headers=1&gid=3';
	var projectsQuery = 'select A, B, C, D, E, H, I';
	var map;
	...
	var primaryProjectLineContructor = {
					strokeColor: "#000000",
					strokeOpacity: 0,
					strokeWeight: 3,
					geodesic: true,
	...
	function createPrimaryProjectVisual(rowOfValues, projectIndex)
	{
		if (rowOfValues != null && rowOfValues.length > 0)
		{
			...
			var projectPolyline = new google.maps.Polyline(primaryProjectLineContructor);
